/* prime_number_algorithm_1.kt */

import kotlin.math.absoluteValue
import kotlin.math.pow

val MAX_ITERATIONS = 7
...
fun yieldImmeasurables(seedImmeasurables: MutableList<Long>, splitSwapIndex: Int) {
    ...
    while (swapCursor < sizeOfCurrentSeedImmeasurables + 1) {
        ...
        if (swapCursor < sizeOfCurrentSeedImmeasurables) {
            ...
            if (splitSwapIndex == 0 && currentLadderStep < MAX_BOUND) {
